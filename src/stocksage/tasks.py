...
def create_analyze_sentiment_task(
    ...
    return Task(
        ...
        expected_output=analyze_sentiment_config.get("expected_output", default_expected_output),
        agent=agent,
        context=context,
        tools=tools,
...
def create_analyze_stock_data_task(
    ...
    return Task(
        ...
        expected_output=analyze_stock_data_config.get("expected_output", default_expected_output),
        agent=agent,
        context=context,
        tools=tools,
        async_execution=async_execution,
...
def create_simplified_thesis_json_task(
    ...
    default_description: str = (
        "Create a simplified JSON file with the investment"
        " theses for the top 5 recommended companies."
    ),
    default_expected_output: str = (
        "A simplified JSON file containing the investment"
        " theses for the top 5 recommended companies."
    ),
):
    """
    ...
    """
    create_simplified_thesis_json_config = tasks_config.get("create_simplified_thesis_json", {})
    return Task(
        description=create_simplified_thesis_json_config.get("description", default_description),
...
def create_generate_investment_thesis_task(
    ...
    default_description: str = (
        ...
        " based on the selected stocks and the"
        " selected sentiment analysis."
    ),
    default_expected_output: str = (
        "A detailed investment thesis for each of the top 5 selected stocks."
    ),
):
    """
    Creates a task for developing comprehensive investment
    theses based on selected stocks and sentiment analysis.
    ...
    """
    generate_investment_thesis_config = tasks_config.get("generate_investment_thesis", {})
    return Task(
        description=generate_investment_thesis_config.get("description", default_description),
...
def create_justify_sentiment_selection_task(
    ...
    default_description: str = (
        "Justify stock selections based on sentiment analysis and financial data."
    ),
    default_expected_output: str = (
        "Detailed justification for stock selections based on sentiment analysis."
    ),
):
    """
    ...
    """
    justify_sentiment_selection_config = tasks_config.get("justify_sentiment_selection", {})
    return Task(
        description=justify_sentiment_selection_config.get("description", default_description),
...
def create_justify_stock_selection_task(
    ...
    default_expected_output: str = (
        "Detailed justification for stock selections based on financial analysis."
    ),
):
    """
    ...
    return Task(
        description=justify_stock_selection_config.get("description", default_description),
...
def create_manage_investment_process_task(
    ...
    tools: list = [YFinanceTool(), AlphaVantageTool()],
    default_description: str = (
        "Monitor and manage the investment process,"
        " including portfolio allocation, risk"
    ...
    """
    Creates a task for monitoring and managing the
    investment process, including portfolio allocation,
    ...
    return Task(
        description=manage_investment_process_config.get("description", default_description),
...
def create_optimize_sentiment_selection_task(
    ...
    default_description: str = (
        "Optimize stock selections based on sentiment analysis and risk-reward profiles."
    ),
    default_expected_output: str = (
        "Optimized stock selections based on sentiment analysis and risk-reward profiles."
    ),
):
    """
    Creates a task for optimizing stock selections based on
    sentiment analysis and risk-reward profiles.
    ...
    """
    optimize_sentiment_selection_config = tasks_config.get("optimize_sentiment_selection", {})
    return Task(
        description=optimize_sentiment_selection_config.get("description", default_description),
...
def create_optimize_stock_selection_task(
    ...
    tools: list = [YFinanceTool(), AlphaVantageTool()],
    default_description: str = (
        "Optimize stock selections based on financial data and risk-reward profiles."
    ),
    default_expected_output: str = (
        "Optimized stock selections based on financial data and risk-reward profiles."
    ),
):
    """
    ...
    return Task(
        description=optimize_stock_selection_config.get("description", default_description),
...
def create_perform_integrated_analysis_task(
    ...
    default_description: str = (
        "Perform detailed integrated analysis combining"
        " financial metrics and sentiment for each"
        " stock."
    ),
    default_expected_output: str = ("A comprehensive integrated analysis report for each stock."),
):
    """
    Creates a task for performing detailed integrated
    analysis combining financial metrics and sentiment
    for stocks.
    ...
    """
    perform_integrated_analysis_config = tasks_config.get("perform_integrated_analysis", {})
    return Task(
        description=perform_integrated_analysis_config.get("description", default_description),
...
def create_refine_stock_analysis_task(
    ...
    return Task(
        description=refine_stock_analysis_config.get("description", default_description),
...
def create_store_thesis_json_task(
    ...
    default_expected_output: str = (
        "A JSON file containing the investment thesis for the top 5 recommended companies."
    ),
):
    """
    ...
    return Task(
        ...
        expected_output=store_thesis_json_config.get("expected_output", default_expected_output),
        agent=agent,
        context=context,
        tools=tools,
        async_execution=async_execution,
...
def create_synthesize_final_selection_task(
    ...
    default_expected_output: str = (
        "Final selection of top 5 most promising investment opportunities."
    ),
):
    """
    ...
    """
    synthesize_final_selection_config = tasks_config.get("synthesize_final_selection", {})
    return Task(
        description=synthesize_final_selection_config.get("description", default_description),
...
def create_terminate_process_task(
    ...
    default_expected_output: str = (
        "All resources properly released and the process terminates cleanly."
    ),
):
    """
    ...
    return Task(
        ...
        expected_output=terminate_process_config.get("expected_output", default_expected_output),
        agent=agent,
...
def create_verify_thesis_json_task(
    ...
    tools: list = [YFinanceTool()],
    default_description: str = (
        "Verify the JSON file with investment theses to ensure accuracy and correctness."
    ),
    default_expected_output: str = (
        "Confirmation that the JSON file is correctly"
        " formatted and contains accurate investment"
        " theses."
    ),
):
    """
    Creates a task for verifying the JSON file with
    investment theses to ensure accuracy and correctness.
    ...
    return Task(
        ...
        expected_output=verify_thesis_json_config.get("expected_output", default_expected_output),
        agent=agent,
        context=context,
        tools=tools,
        async_execution=async_execution,
