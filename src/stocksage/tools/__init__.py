"""
This module contains the tools that are used to fetch data from
various sources. The tools are used to fetch data from APIs,
websites, and other sources. The tools are designed to be modular
and reusable, so they can be easily integrated into other parts
of the application.

To use a tool, you need to import it from the stocksage.tools
module and create an instance of the tool. For example:
```
